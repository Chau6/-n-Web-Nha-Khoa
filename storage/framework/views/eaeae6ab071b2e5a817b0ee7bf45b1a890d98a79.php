                ...
                <div class="about-logo-box">
                    ...
                    <ul class="fix">
                        <li class="wow fadeInDown" data-wow-delay="300ms">
                            <img src="<?php echo e(asset('asset/client/images/resources/certificate-1.png')); ?>" alt="Image">
                        </li>
                        <li class="wow fadeInUp" data-wow-delay="600ms">
                            <img src="<?php echo e(asset('asset/client/images/resources/certificate-2.png')); ?>" alt="Image">
                        </li>
                        <li class="wow fadeInUp" data-wow-delay="900ms">
                            <img src="<?php echo e(asset('asset/client/images/resources/certificate-3.png')); ?>" alt="Image">
                        </li>      
                    </ul>
                </div>    
            </div>
            <div class="col-xl-6">
                <div class="about-text-holder">
                    ...
                    <div class="author-box fix">
                        <div class="img-box">
                            <img src="<?php echo e(asset('asset/client/images/resources/ceo.png')); ?>" alt="Awesome Image">
                        </div>
                        <div class="text-box">
                        ...
                        <div class="signatire-box">
                            <img src="<?php echo e(asset('asset/client/images/resources/signature.png')); ?>" alt="Signature">
                        </div>
                    </div>
                    <div class="read-more">
...
</section><?php /**PATH C:\Users\me016\OneDrive\Tài liệu\GitHub\-n-Web-Nha-Khoa\resources\views/client/blocks/about_area.blade.php ENDPATH**/ ?>