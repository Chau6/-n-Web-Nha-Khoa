        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                <div class="single-solution-style1 wow fadeInUp" data-wow-delay="300ms">
                    <div class="img-holder">
                        <img src="<?php echo e(asset('asset/client/images/services/1.jpg')); ?>" alt="Awesome Image">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                <div class="single-solution-style1 wow fadeInUp" data-wow-delay="600ms">
                    <div class="img-holder">
                        <img src="<?php echo e(asset('asset/client/images/services/2.jpg')); ?>" alt="Awesome Image">
                        <div class="icon-holder">
                            <div class="inner-content">
                                <div class="box">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                <div class="single-solution-style1 wow fadeInUp" data-wow-delay="900ms">
                    <div class="img-holder">
                        <img src="<?php echo e(asset('asset/client/images/services/3.jpg')); ?>" alt="Awesome Image">
                        <div class="icon-holder">
                            <div class="inner-content">
                                <div class="box">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                <div class="single-solution-style1 wow fadeInUp" data-wow-delay="300ms">
                    <div class="img-holder">
                        <img src="<?php echo e(asset('asset/client/images/services/4.jpg')); ?>" alt="Awesome Image">
                        <div class="icon-holder">
                            <div class="inner-content">
                                <div class="box">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                <div class="single-solution-style1 wow fadeInUp" data-wow-delay="600ms">
                    <div class="img-holder">
                        <img src="<?php echo e(asset('asset/client/images/services/5.jpg')); ?>" alt="Awesome Image">
                        <div class="icon-holder">
                            <div class="inner-content">
                                <div class="box">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                <div class="single-solution-style1 wow fadeInUp" data-wow-delay="900ms">
                    <div class="img-holder">
                        <img src="<?php echo e(asset('asset/client/images/services/6.jpg')); ?>" alt="Awesome Image">
                        <div class="icon-holder">
                            <div class="inner-content">
                                <div class="box">
...
</section><?php /**PATH C:\Users\ACER\Desktop\Chau_folder\GitHub\-n-Web-Nha-Khoa\resources\views/client/blocks/services_style1.blade.php ENDPATH**/ ?>