...
<head>
  ...
  <!-- icheck bootstrap -->
  <link rel="stylesheet" href="<?php echo e(asset('asset/page/plugins/icheck-bootstrap/icheck-bootstrap.min.css')); ?>">
  <!-- Theme style -->
...
<div class="register-box">
  <div class="card card-outline card-primary">
    ...
    <div class="card-body">
      ...
      <a href="<?php echo e(route('getLogin')); ?>" class="text-center">Login</a>
    </div>
    <!-- /.form-box -->
  </div><!-- /.card -->
</div>
...
<?php /**PATH C:\Users\ACER\Desktop\Chau_folder\GitHub\-n-Web-Nha-Khoa\resources\views/register.blade.php ENDPATH**/ ?>