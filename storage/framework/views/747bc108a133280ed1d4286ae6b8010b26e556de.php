                    ...
                    <nav class="main-menu style1 clearfix">
                        ...
                        <div class="navbar-collapse collapse clearfix">
                            <ul class="navigation clearfix">
                                ...
                                <li class="dropdown"><a href="<?php echo e(route('client.pages.specialities')); ?>">Specialities</a>
                                    <ul>
...
<section class="breadcrumb-area" style="background-image: url(<?php echo e(asset('asset/images/resources/breadcrumb-bg.jpg')); ?>);">
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
                <div class="inner-content clearfix">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('client.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ACER\Desktop\Chau_folder\GitHub\-n-Web-Nha-Khoa\resources\views/client/pages/appointment.blade.php ENDPATH**/ ?>