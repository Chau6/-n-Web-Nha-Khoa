                    ...
                    <nav class="main-menu style1 clearfix">
                        ...
                        <div class="navbar-collapse collapse clearfix">
                            <ul class="navigation clearfix">
                                <li id="about_us"><a href="<?php echo e(route('client.pages.about')); ?>">About Us</a></li>
                                <li class="dropdown" id="health_screening"><a href="<?php echo e(route('client.pages.specialities')); ?>">Health Screening</a>
                                    <ul>
                                        <li><a href="<?php echo e(route('client.pages.advice')); ?>">Advice</a></li>
                                        <li><a href="">Care Services</a></li>
                                        <li><a href="<?php echo e(route('client.pages.product')); ?>">Support Products</a></li>
                                    </ul>
                                </li>
                                <li class="dropdown"><a href="<?php echo e(route('client.pages.specialities')); ?>">Products</a>
                                    <ul>
                                        <li><a href="<?php echo e(route('client.pages.advice')); ?>">Advice</a></li>
...
</section><?php /**PATH C:\Users\me016\OneDrive\Tài liệu\GitHub\-n-Web-Nha-Khoa\resources\views/client/blocks/main_menu.blade.php ENDPATH**/ ?>