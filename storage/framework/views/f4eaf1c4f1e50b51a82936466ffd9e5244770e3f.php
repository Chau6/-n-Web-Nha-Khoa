    ...
    <div class="container inner-content">
        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12">
                <div class="single-blog-post">
                    <div class="img-holder">
                        <img src="<?php echo e(asset('asset/client/images/blog/lat-blog-1.jpg')); ?>" alt="Awesome Image">
                    ...
                    <div class="text-holder">
                        <div class="meta-box">
                            <div class="author-thumb">
                                <img src="<?php echo e(asset('asset/client/images/blog/author-1.png')); ?>" alt="Image">
                            </div>
                            <ul class="meta-info">
            ...
            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12">
                <div class="single-blog-post">
                    <div class="img-holder">
                        <img src="<?php echo e(asset('asset/client/images/blog/lat-blog-2.jpg')); ?>" alt="Awesome Image">
                        <div class="categorie-button">
                    ...
                    <div class="text-holder">
                        <div class="meta-box">
                            <div class="author-thumb">
                                <img src="<?php echo e(asset('asset/client/images/blog/author-2.png')); ?>" alt="Image">
                            </div>
                            <ul class="meta-info">
                                <li><a href="#">By Megan Clarks</a></li>
                                <li><a href="#">Nov 14, 2018</a></li>
            ...
            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12">
                <div class="single-blog-post">
                    <div class="img-holder">
                        <img src="<?php echo e(asset('asset/client/images/blog/lat-blog-3.jpg')); ?>" alt="Awesome Image">
                        <div class="categorie-button">
                    ...
                    <div class="text-holder">
                        <div class="meta-box">
                            <div class="author-thumb">
                                <img src="<?php echo e(asset('asset/client/images/blog/author-3.png')); ?>" alt="Image">
                            </div>
                            <ul class="meta-info">
                                <li><a href="#">By Megan Clarks</a></li>
                                <li><a href="#">Nov 14, 2018</a></li>
...
</section><?php /**PATH C:\Users\me016\OneDrive\Tài liệu\GitHub\-n-Web-Nha-Khoa\resources\views/client/blocks/latest_blog_area.blade.php ENDPATH**/ ?>