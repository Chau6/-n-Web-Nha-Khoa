                    ...
                    <nav class="main-menu style1 clearfix">
                        ...
                        <div class="navbar-collapse collapse clearfix">
                            <ul class="navigation clearfix">
                                <li class="dropdown current"><a href="<?php echo e(route('client.pages.index')); ?>">Home</a>
                                </li>
                                ...
                                <li class="dropdown"><a href="<?php echo e(route('client.pages.specialities')); ?>">Specialities</a>
                                    <ul>
                                        <li><a href="<?php echo e(route('client.pages.advice')); ?>">Advice</a></li>                                        <li><a href="spec-cosmetic-dentistry.html">Cosmetic Dentistry</a></li>
...
</section><?php /**PATH C:\Users\ACER\Desktop\Chau_folder\GitHub\-n-Web-Nha-Khoa\resources\views/client/blocks/main_menu.blade.php ENDPATH**/ ?>