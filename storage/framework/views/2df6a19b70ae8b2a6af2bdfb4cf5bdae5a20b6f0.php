                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-5 col-lg-7 col-md-10 col-sm-12">
                                        <div class="img-holder">
                                            <img src="<?php echo e(asset('asset/client/images/team/team-1.png')); ?>" alt="Awesome Image">
                        ...
                        <li>
                            <div class="single-team-slide clearfix">
                                <div class="row">
                                    ...
                                    <div class="col-xl-5 col-lg-7 col-md-10 col-sm-12">
                                        <div class="img-holder">
                                            <img src="<?php echo e(asset('asset/client/images/team/team-2.png')); ?>" alt="Awesome Image">
                                            <ul class="team-social-links">
                                                <li><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                                                <li><a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                                                <li><a href="#"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
                        ...
                        <ul class="thumb-box style2">
                            <li>
                                <a class="active" data-slide-index="0" href="#">
                                    <div class="img-holder">
                                        <img src="<?php echo e(asset('asset/client/images/team/team-thumb-1.jpg')); ?>" alt="Awesome Image">    
                                    </div>
                            ...
                            <li>
                                <a data-slide-index="1" href="#">
                                    <div class="img-holder">
                                        <img src="<?php echo e(asset('asset/client/images/team/team-thumb-2.jpg')); ?>" alt="Awesome Image">    
                                    </div>
                                    <div class="text-holder">
...
</section><?php /**PATH C:\Users\me016\OneDrive\Tài liệu\GitHub\-n-Web-Nha-Khoa\resources\views/client/blocks/team_area_v2.blade.php ENDPATH**/ ?>