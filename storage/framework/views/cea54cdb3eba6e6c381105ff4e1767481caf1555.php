<section class="choose-area">
    <div class="container">
        ...
        <div class="row">
            <div class="col-xl-6">
                <div class="choose-carousel owl-carousel owl-theme" style="background-image: url(<?php echo e(asset('asset/client/images/parallax-background/choose-carousel-bg.jpg')); ?>);">
            ...
            <div class="col-xl-6">
                <div class="video-holder-box" style="background-image: url(<?php echo e(asset('asset/client/images/parallax-background/video-holder-bg.jpg')); ?>);">
                    <div class="icon-holder">
                        <div class="icon">
                            <div class="inner">
...
</section> <?php /**PATH C:\Users\ACER\Desktop\Chau_folder\GitHub\-n-Web-Nha-Khoa\resources\views/client/blocks/choose_area.blade.php ENDPATH**/ ?>