        ...
        <div class="row">
            <div class="col-xl-8">
                <div class="appointment-form-left">
                    <form action="{{ route('client.pages.update', ['id' => $id]) }}" id="checkform" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-12">
                                <div class="single-box">
                                    ...
                                    <div class="input-box">
                                        <div class="col-xl-6">
                                            <div class="form-group">
                                                <input type="text" name="phone" id="phone" value="{{$edit->phone}}" placeholder="Ph Num*">   
                                                @error('phone')
                                                    <small class="form-text invalid-feedback">{{$message}}</small>
                                                @enderror
                                            </div>  
                            ...
                            <div class="col-xl-12 col-lg-12">
                                <div class="single-box">
                                    ...
                                    <div class="input-box">
                                        <div class="col-xl-6">
                                            <div class="form-group">
                                                <input type="text" value="{{$edit->date}}" name="date" class="date-input" id="date-in" placeholder="Date"> 
                                                @error('date')
                                                    <small class="form-text invalid-feedback">{{$message}}</small>
                                                @enderror
                                            </div>
