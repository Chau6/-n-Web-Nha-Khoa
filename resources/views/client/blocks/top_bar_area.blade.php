                    ...
                    <ul class="sociallinks-style-one">
                        ...
                        <ul class="navbar-nav ml-auto">
                            <li class="nav-item dropdown">
                                <a href="{{route('client.pages.information_client')}}" style="color: #AFBDBB; font-size: 15px; border: 2px #AFBDBB solid; border-radius: 0.3em; padding: 3px">{{auth()->user()->username}}</a>  ||   
