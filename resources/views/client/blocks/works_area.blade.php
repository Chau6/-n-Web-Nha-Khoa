                                        ...
                                        <div class="row mar0">
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 pd0">
                                                <div class="img-holder">
                                                    <img src="{{ asset('asset/client/images/resources/teeth-before-1.jpg') }}" alt="Awesome Image">
                                                    <div class="before">
                                                        <a href="#">Before</a>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 pd0">
                                                <div class="img-holder">
                                                    <img src="{{ asset('asset/client/images/resources/teeth-after-1.jpg') }}" alt="Awesome Image">
                                                    <div class="after">
                                                        <a href="#">After</a>
                                                    </div>
                                                </div>    
