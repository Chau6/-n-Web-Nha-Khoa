                ...
                <div class="team-carousel owl-carousel owl-theme">
                    ...
                    <div class="single-team-member">
                        <div class="img-holder">
                            <img src="{{asset('asset/client/images/team/1.jpg')}}" alt="Awesome Image">
                    ...
                    <div class="single-team-member">
                        <div class="img-holder">
                            <img src="{{asset('asset/client/images/team/2.jpg')}}" alt="Awesome Image">
                            <div class="overlay-style-one"></div>
                            <div class="text-holder text-center">
                    ...
                    <div class="single-team-member">
                        <div class="img-holder">
                            <img src="{{asset('asset/client/images/team/3.jpg')}}" alt="Awesome Image">
                            <div class="overlay-style-one"></div>
                            <div class="text-holder text-center">
